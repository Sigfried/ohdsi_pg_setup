...
With these files you might consider manually copying and pasting each copy command one at a time
...
For each of these, I removed the problematic characters from the line and tried again. This is **not**
the recommended approach. I don't know what the recommended approach is, so I spent way too long repeating
this kludge over and over.

I will not save a dump of the database after loading vocabulary files because 1) it would be big, and 2)
it might violate licensing restrictions.
